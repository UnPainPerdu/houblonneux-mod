...
public class RealDwarveConsumeEffect extends AbstractBeerConsumeEffect
{
    ...
    public static final String BOTTLE_TOOLTIP_KEY = "item.real_dwarve.bottle.tooltip";
    public static final String GLASS_TOOLTIP_KEY = "item.real_dwarve.glass.tooltip";
    public static final String MUG_TOOLTIP_KEY = "item.real_dwarve.mug.tooltip";
    ...
    {
        Holder<MobEffect> effect = ModMobEffectRegister.REAL_DWARVE;
