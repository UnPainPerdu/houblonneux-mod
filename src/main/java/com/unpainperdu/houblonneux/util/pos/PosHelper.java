...
{
    public static DirectionalPosGetter getDirectionalPosGetter(Direction direction, BlockPos basePos)
    {
        return new DirectionalPosGetter(direction, basePos.getX(), basePos.getY(), basePos.getZ());
    }
    ...
    public static BlockPos changeRandomlyYPos(RandomSource rand, BlockPos pos, int minOffset, int maxOffSet)
    {
        ...
        int yChange = rand.nextInt(maxOffSet - minOffset + 1) + minOffset;
