...
public class ModItemProperties
{
    ...
    public static final Item.Properties BOTTLE_BEER_PROPERTIES = new Item.Properties()
            ...
            .craftRemainder(new ItemStackTemplate(ModItemRegister.BOTTLE))
            .component(DataComponents.USE_REMAINDER, new UseRemainder(new ItemStackTemplate(ModItemRegister.BOTTLE)))
    ...
    public static final Item.Properties GLASS_BEER_PROPERTIES = new Item.Properties()
            ...
            .component(DataComponents.USE_REMAINDER, new UseRemainder(new ItemStackTemplate(ModItemRegister.GLASS)))
            .component(DataComponents.CONSUMABLE, BEER_CONSUMABLE);
    public static final Item.Properties MUG_BEER_PROPERTIES = new Item.Properties()
            .food(new FoodProperties(5, 0.9F, true))
            .component(DataComponents.USE_REMAINDER, new UseRemainder(new ItemStackTemplate(ModItemRegister.MUG)))
            .component(DataComponents.CONSUMABLE, BEER_CONSUMABLE);
}