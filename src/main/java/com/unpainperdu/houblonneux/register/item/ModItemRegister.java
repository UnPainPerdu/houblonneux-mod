...
public class ModItemRegister
{
    ...
    //beer
    //  empty
    public static final DeferredItem<Item> EMPTY_BOTTLE = ITEMS.registerItem("empty_bottle", Item::new);
    public static final DeferredItem<Item> EMPTY_GLASS = ITEMS.registerItem("empty_glass", Item::new);
    public static final DeferredItem<Item> EMPTY_MUG = ITEMS.registerItem("empty_mug", Item::new);
    //  emerald_call
