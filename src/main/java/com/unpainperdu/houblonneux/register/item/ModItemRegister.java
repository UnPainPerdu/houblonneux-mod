...
public class ModItemRegister
{
    ...
    //beer
    //  empty
    public static final DeferredItem<Item> BOTTLE = ITEMS.registerItem("bottle", Item::new);
    public static final DeferredItem<Item> GLASS = ITEMS.registerItem("glass", Item::new);
    public static final DeferredItem<Item> MUG = ITEMS.registerItem("mug", Item::new);
    //  emerald_call
